    ...
    <form action="{{ route('pokedexs.store') }}" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="number" step="0.1" class="form-control" id="hp" name="hp" required>
            </div>

            <div class="col-md-6 mb-3">
                <label for="attack" class="form-label">Attack</label>
                <input type="number" step="0.1" class="form-control" id="attack" name="attack" required>
            </div>

            <div class="col-md-6 mb-3">
                <label for="defense" class="form-label">Defense</label>
                <input type="number" step="0.1" class="form-control" id="defense" name="defense" required>
            </div>
